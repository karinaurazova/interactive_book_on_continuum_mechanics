...
const text = {
  ru: {
    ...
    keyText:'При отсутствии распределённых пар и couple stresses локальный баланс момента импульса даёт σ = σᵀ.',
    ...
    warningText:'Она следует для классического неполярного континуума без независимых моментных взаимодействий. В Cosserat- и couple-stress теориях напряжения могут быть несимметричны.',
