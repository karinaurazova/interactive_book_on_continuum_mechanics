...
const text = {
  ru: {
    ...
    mappingText: 'В первом приближении около выбранной точки: dx = F dX. Столбцы матрицы F — это образы базисных материальных направлений.',
    jacobian: 'Локальное изменение площади',
    jacobianText: 'В двумерной сцене det F показывает ориентированное локальное отношение площадей. В 3D аналогично J = det F связан с локальным изменением объёма.',
    warning: 'ВАЖНО',
    ...
    questionText: 'Первый столбец — образ единичного направления e₁, второй — образ e₂. Любой dX получается их линейной комбинацией.',
    conclusion: 'ВЫВОД',
  ...
  en: {
    ...
    mappingText: 'To first order near the selected point: dx = F dX. The columns of F are the images of the material basis directions.',
    jacobian: 'Local area change',
    jacobianText: 'In this two-dimensional scene det F gives the oriented local area ratio. In 3D, J = det F is analogously related to local volume change.',
    warning: 'IMPORTANT',
    ...
    questionText: 'The first column is the image of unit direction e₁; the second is the image of e₂. Any dX is their linear combination.',
