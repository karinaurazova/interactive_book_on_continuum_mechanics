...
const text = {
  ru: {
    back: '← M13',
    title: 'Итоговая самопроверка: исследование тензора',
    ...
    complete: 'выполнено',
    pending: 'в процессе',
    progress: 'Прогресс самопроверки',
    angle: 'угол нормали',
    tau: '|τ|',
    sigmaN: 'σₙ',
    i1: 'I₁',
    ...
    devTrace: 'tr(s)',
    reset: 'сбросить',
    finish: 'Самопроверка завершена',
    finishText: 'Все условия выполнены. Геометрия площадки, вектор напряжения, главные значения, инварианты и девиаторное разложение связаны в одном исследовании.',
