...
keyText:'Глобальный МКЭ передаёт в материальную точку новую деформацию; локальный обновление состояния возвращает напряжение, обновлённые внутренние переменные и алгоритмическую касательную.',
