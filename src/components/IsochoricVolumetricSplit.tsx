...
export function IsochoricVolumetricSplit({notation,language,onBack}:Props){
 ...
 <ApplicationLinks language={language} items={[{ru:'Мягкие ткани',en:'Soft tissues'},{ru:'Эластомеры',en:'Elastomers'},{ru:'Нелинейный FEM',en:'Nonlinear FEM'},{ru:'Смешанные u–p постановки',en:'Mixed u–p formulations'}]}/>
