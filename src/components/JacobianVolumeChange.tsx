...
const text = {
  ru: {
    ...
    preserved: 'J = 1',
    preservedText: 'Локальная площадь/объём сохраняется.',
    contraction: '0 < J < 1',
    ...
    warningText: 'Это условие связано с сохранением локальной ориентации и невырожденностью отображения. Для физически допустимого движения также важна глобальная взаимная однозначность.',
  ...
  en: {
    ...
    preserved: 'J = 1',
    preservedText: 'Local area/volume is preserved.',
    contraction: '0 < J < 1',
    ...
    warningText: 'This is tied to preservation of local orientation and nonsingularity of the motion. Global injectivity is also important for a physically admissible motion.',
    question: 'CHECKPOINT',
