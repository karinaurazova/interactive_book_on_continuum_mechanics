...
const text = {
  ru: {
    ...
    localText: 'Если движение достаточно гладкое, то в достаточно малой окрестности его изменение в первом порядке можно аппроксимировать линейным отображением.',
    preview: 'ПРЕДВАРИТЕЛЬНЫЙ ВЗГЛЯД',
    previewText: 'В следующем модуле матрица этой локальной линейзации получит имя — градиент деформации F.',
  ...
  en: {
    ...
    localText: 'If the motion is sufficiently smooth, then in a sufficiently small neighborhood its first-order change can be approximated by a linear map.',
    preview: 'PREVIEW',
    previewText: 'In the next module the matrix of this local linearization will be identified as the deformation gradient F.',
