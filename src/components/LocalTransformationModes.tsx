...
const text = {
  ru: {
    ...
    rotation: 'Поворот',
    combined: 'Комбинация',
    stretchText: 'В этом примере диагональная F независимо масштабирует два выбранных базисных направления.',
    ...
    questionText: 'При собственно жёстком повороте FᵀF = I и det F = +1: сохраняются все длины и углы, меняется только ориентация.',
    conclusion: 'ВЫВОД',
  ...
  en: {
    ...
    rotation: 'Rotation',
    combined: 'Combined',
    stretchText: 'In this example a diagonal F independently scales the two chosen basis directions.',
    ...
    questionText: 'For a proper rigid rotation, FᵀF = I and det F = +1: all lengths and angles are preserved and only orientation changes.',
