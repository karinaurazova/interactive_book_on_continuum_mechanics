...
const text = {
  ru: {
    ...
    keyText:'Для скалярного поля φ(x,t): Dφ/Dt = ∂φ/∂t + v·∇φ. Для компонентов векторных и тензорных полей в фиксированном базисе оператор применяется аналогично; вопрос объективных тензорных производных возникает отдельно.',
  ...
  en: {
    ...
    keyText:'For a scalar field φ(x,t): Dφ/Dt = ∂φ/∂t + v·∇φ. In a fixed basis the operator applies componentwise to vector and tensor fields; objective tensor rates are a separate issue.',
