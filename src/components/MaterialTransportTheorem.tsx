...
const text = {
  ru: {
    ...
    second:'Второй вклад',
    secondText:'φ ∇·v возникает из изменения локального элемента объёма: d(dv)/dt = (∇·v) dv.',
  ...
  en: {
    ...
    secondText:'φ ∇·v comes from the change of the local volume element: d(dv)/dt = (∇·v) dv.',
