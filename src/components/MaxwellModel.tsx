...
const text={
ru:{
title:'Модель Максвелла: пружина и демпфер последовательно',
lead:'Модель Максвелла — минимальная схема, в которой упругая и вязкая деформации складываются, а напряжение в обоих элементах одинаково.',
key:'ПОСЛЕДОВАТЕЛЬНОЕ СОЕДИНЕНИЕ',
keyText:'ε = εₑ + εᵥ,   σₑ = σᵥ = σ.',
eq:'Определяющее уравнение',
eqText:'Сочетая σ=Eεₑ и σ=η ε̇ᵥ, получаем ε̇ = σ̇/E + σ/η.',
relax:'Релаксация',
relaxText:'При ε=const напряжение экспоненциально спадает: σ(t)=σ₀e^(−t/τ), где τ=η/E.',
creep:'Ползучесть',
