...
const text = {
  ru: {
    ...
    questionText: 'Меняй только поворот и наблюдай: положение точек меняется, но расстояния между ними могут сохраняться.',
    conclusion: 'ВЫВОД',
  ...
  en: {
    ...
    questionText: 'Change only the rotation and observe: point positions change while distances between them may remain unchanged.',
