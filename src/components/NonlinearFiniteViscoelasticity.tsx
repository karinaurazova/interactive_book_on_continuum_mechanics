...
mode:'закон релаксации',constant:'τ = const',stateMode:'τ = τ(λ)',
amplitude:'амплитуда log λ',omega:'частота ω',tau0:'базовое τ₀',beta:'чувствительность β',
tauMin:'min τ',tauMax:'max τ',diss:'площадь петли',peak:'max |σ|',
warning:'ВАЖНО',
...
mode:'relaxation law',constant:'τ = const',stateMode:'τ = τ(λ)',
amplitude:'log-stretch amplitude',omega:'frequency ω',tau0:'base τ₀',beta:'sensitivity β',
tauMin:'min τ',tauMax:'max τ',diss:'loop area',peak:'max |σ|',
warning:'IMPORTANT',
