...
const text = {
  ru: {
    ...
    lead: 'Для невырожденной F с J > 0 локальное преобразование можно строго представить через положительно определённое растяжение и собственно жёсткий поворот. Полярное разложение даёт два эквивалентных пути.',
    key: 'КЛЮЧЕВАЯ МЫСЛЬ',
    ...
    warningText: 'U и V симметричны и положительно определены для невырожденной F; они имеют одинаковые главные растяжения, но относятся к разным конфигурациям. Связь: V = R U Rᵀ.',
  ...
  en: {
    ...
    lead: 'For nonsingular F with J > 0, the local transformation can be represented rigorously by a positive-definite stretch and a proper rigid rotation. Polar decomposition gives two equivalent paths.',
    key: 'KEY IDEA',
    ...
    warningText: 'For nonsingular F, U and V are symmetric positive definite. They share the same principal stretches but belong to different configurations, with V = R U Rᵀ.',
    question: 'CHECKPOINT',
