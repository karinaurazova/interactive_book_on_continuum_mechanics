...
const text = {
  ru: {
    ...
    spin:'Тензор спина W',
    spinText:'W — кососимметричная часть градиента скорости, связанная с локальной жёстко-поворотной частью мгновенного движения. В 3D её аксиальный вектор равен половине вихря скорости.',
  ...
  en: {
    ...
    spin:'Spin tensor W',
    spinText:'W is the skew-symmetric part of the velocity gradient associated with the local rigid-rotation part of the instantaneous motion. In 3D its axial vector equals one half of the velocity vorticity.',
