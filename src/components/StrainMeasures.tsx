...
const text = {
  ru: {
    ...
    lead: 'Тензоры C и B кодируют изменение метрики в материальном и пространственном описаниях. Из них можно построить меры деформации, привязанные к соответствующей конфигурации.',
    key: 'КЛЮЧЕВАЯ МЫСЛЬ',
    ...
    warningText: 'E относится к референсной конфигурации, e — к текущей. Поэтому покомпонентное сравнение без преобразования между конфигурациями не имеет прямого смысла.',
  ...
  en: {
    ...
    lead: 'The tensors C and B encode metric change in material and spatial descriptions. From them we can construct strain measures tied to the corresponding configuration.',
    key: 'KEY IDEA',
    ...
    warningText: 'E belongs to the reference configuration and e to the current one. A component-by-component comparison without mapping between configurations has no direct meaning.',
    question: 'CHECKPOINT',
