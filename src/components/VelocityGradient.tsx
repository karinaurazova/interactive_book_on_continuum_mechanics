...
const text = {
  ru: {
    ...
    bridgeText:'Поскольку d𝐱 = 𝐅 d𝐗, дифференцирование по времени при фиксированном материальном приращении d𝐗 даёт d𝐯 = Ḟ d𝐗 = ḞF⁻¹ d𝐱.',
    time:'время t',
    ...
    conclusion:'ВЫВОД',
    conclusionTitle:'L описывает мгновенную локальную неоднородность поля скорости, тогда как F связывает соседние точки между конфигурациями.',
  ...
  en: {
    ...
    bridgeText:'Since d𝐱 = 𝐅 d𝐗, differentiating in time at fixed material increment d𝐗 gives d𝐯 = Ḟ d𝐗 = ḞF⁻¹ d𝐱.',
    time:'time t',
    ...
    conclusionTitle:'L describes the instantaneous local variation of velocity, whereas F maps neighboring material increments between configurations.',
