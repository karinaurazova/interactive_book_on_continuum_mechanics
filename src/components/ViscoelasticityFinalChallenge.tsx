...
question1:'В тесте релаксации напряжение быстро падает, но выходит на ненулевое плато. Какой вывод наиболее обоснован?',
...
question4:'Неявное обновление состояния устойчиво, но глобальный метод Ньютона в МКЭ сходится медленно. Что следует проверить в первую очередь?',
...
question4:'An implicit обновление состояния is stable, but global FEM Newton iterations converge slowly. What should be checked first?',
