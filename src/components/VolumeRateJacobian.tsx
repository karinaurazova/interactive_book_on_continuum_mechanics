...
const text = {
  ru: {
    ...
    keyText:'Для гладкого локально обратимого движения с J = det F выполняется точное тождество: J̇ = J tr L = J tr D = J ∇·v.',
  ...
  en: {
    ...
    keyText:'For a smooth locally invertible motion with J = det F, the exact identity is J̇ = J tr L = J tr D = J ∇·v.',
