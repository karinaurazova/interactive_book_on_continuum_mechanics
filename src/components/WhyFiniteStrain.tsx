...
const text = {
  ru: {
    ...
    sceneKicker:'МАЛАЯ И КОНЕЧНАЯ ДЕФОРМАЦИЯ',
    ...
    researchText:'В нелинейном методе конечных элементов (МКЭ) геометрическая нелинейность возникает уже на уровне кинематики и слабой формы, даже если сам материал остаётся гиперупругим и без внутренних переменных.',
