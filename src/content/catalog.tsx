...
export const modules: ModuleDefinition[] = [
  ...
  { id: 'D05', chapterId: 'finite-strain-hyperelasticity', title: { ru: 'Ogden: гиперупругость через главные растяжения', en: 'Ogden: hyperelasticity through principal stretches' }, subtitle: { ru: 'роль α и сильная нелинейность', en: 'role of α and strong nonlinearity' }, render: ({notation,language,goTo}) => <OgdenModel notation={notation} language={language} onBack={() => goTo('D04')} onNext={() => goTo('D06')} /> },
