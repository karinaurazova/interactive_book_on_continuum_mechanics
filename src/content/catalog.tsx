...
export const chapters: ChapterDefinition[] = [
  ...
  },
  {
    ...
    moduleIds: ['D00', 'D01', 'D02', 'D03', 'D04', 'D05', 'D06', 'D07', 'D08', 'D09', 'D10', 'D11', 'D12', 'D13'],
  },
]
...
export const modules: ModuleDefinition[] = [
  ...
  { id: 'D13', chapterId: 'finite-strain-hyperelasticity', title: { ru: 'Вычислительная лаборатория конечных деформаций и устойчивости', en: 'Computational laboratory for finite strain and stability' }, subtitle: { ru: 'гиперупругость · касательная жёсткость · ветви · несовершенства', en: 'hyperelasticity · tangent stiffness · branches · imperfections' }, render: ({notation,language,goTo}) => <FiniteStrainComputationalLab notation={notation} language={language} onBack={() => goTo('D12')} /> },
]
