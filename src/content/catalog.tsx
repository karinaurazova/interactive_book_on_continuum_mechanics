...
export const modules: ModuleDefinition[] = [
  ...
  { id: 'T03', chapterId: 'transport', title: { ru: 'Материальная производная', en: 'Material derivative' }, subtitle: { ru: 'D/Dt = ∂/∂t + v·∇', en: 'D/Dt = ∂/∂t + v·∇' }, render: ({notation,language,goTo}) => <MaterialDerivative notation={notation} language={language} onBack={() => goTo('T02')} /> },
]
