...
import { NonlinearFiniteViscoelasticity } from '../components/NonlinearFiniteViscoelasticity'
...
export const chapters: ChapterDefinition[] = [
  ...
  },
  {
    ...
    moduleIds: ['E00', 'E01', 'E02', 'E03', 'E04', 'E05', 'E06', 'E07', 'E08', 'E09', 'E10', 'E11'],
  },
]
...
export const modules: ModuleDefinition[] = [
  ...
  { id: 'E11', chapterId: 'viscoelasticity-memory', title: { ru: 'Идентификация параметров и практическая идентифицируемость', en: 'Parameter identification and practical identifiability' }, subtitle: { ru: 'experiment design · sensitivity · correlation · τ₁/τ₂', en: 'experiment design · sensitivity · correlation · τ₁/τ₂' }, render: ({notation,language,goTo}) => <ParameterIdentifiability notation={notation} language={language} onBack={() => goTo('E10')} /> },
]
