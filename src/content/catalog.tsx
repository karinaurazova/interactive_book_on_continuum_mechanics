...
export const chapters: ChapterDefinition[] = [
  ...
  },
  {
    ...
    moduleIds: ['C00', 'C01', 'C02', 'C03', 'C04', 'C05', 'C06', 'C07'],
  },
]
...
export const modules: ModuleDefinition[] = [
  ...
  { id: 'C07', chapterId: 'constitutive-modeling', title: { ru: 'Объёмный и девиаторный отклик через K и G', en: 'Volumetric and deviatoric response through K and G' }, subtitle: { ru: 'объём ↔ форма', en: 'volume ↔ shape' }, render: ({notation,language,goTo}) => <VolumetricDeviatoricElasticity notation={notation} language={language} onBack={() => goTo('C06')} /> },
]
