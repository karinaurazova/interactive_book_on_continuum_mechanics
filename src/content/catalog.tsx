...
export const modules: ModuleDefinition[] = [
  ...
  { id: 'E03', chapterId: 'viscoelasticity-memory', title: { ru: 'Модель Kelvin–Voigt', en: 'Kelvin–Voigt model' }, subtitle: { ru: 'пружина + демпфер параллельно', en: 'spring + dashpot in parallel' }, render: ({notation,language,goTo}) => <KelvinVoigtModel notation={notation} language={language} onBack={() => goTo('E02')} onNext={() => goTo('E04')} /> },
  { id: 'E04', chapterId: 'viscoelasticity-memory', title: { ru: 'Стандартное линейное твёрдое тело (Zener)', en: 'Standard Linear Solid (Zener)' }, subtitle: { ru: 'мгновенная и равновесная жёсткость', en: 'instantaneous and equilibrium stiffness' }, render: ({notation,language,goTo}) => <StandardLinearSolid notation={notation} language={language} onBack={() => goTo('E03')} /> },
]
