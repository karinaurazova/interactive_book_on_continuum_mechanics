...
export const modules: ModuleDefinition[] = [
  ...
  { id: 'C02', chapterId: 'constitutive-modeling', title: { ru: 'Материальная объективность', en: 'Material objectivity' }, subtitle: { ru: 'F* = QF, C* = C, σ* = QσQᵀ', en: 'F* = QF, C* = C, σ* = QσQᵀ' }, render: ({notation,language,goTo}) => <MaterialObjectivity notation={notation} language={language} onBack={() => goTo('C01')} /> },
]
