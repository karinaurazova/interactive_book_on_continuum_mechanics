...
export const chapters: ChapterDefinition[] = [
  ...
  },
  {
    ...
    moduleIds: ['D00', 'D01', 'D02', 'D03', 'D04', 'D05'],
  },
]
...
export const modules: ModuleDefinition[] = [
  ...
  { id: 'D04', chapterId: 'finite-strain-hyperelasticity', title: { ru: 'Neo-Hookean и Mooney–Rivlin', en: 'Neo-Hookean and Mooney–Rivlin' }, subtitle: { ru: 'что меняет зависимость от I₂', en: 'what changes when I₂ enters the energy' }, render: ({notation,language,goTo}) => <HyperelasticModelComparison notation={notation} language={language} onBack={() => goTo('D03')} onNext={() => goTo('D05')} /> },
  { id: 'D05', chapterId: 'finite-strain-hyperelasticity', title: { ru: 'Ogden: гиперупругость через главные растяжения', en: 'Ogden: hyperelasticity through principal stretches' }, subtitle: { ru: 'роль α и сильная нелинейность', en: 'role of α and strong nonlinearity' }, render: ({notation,language,goTo}) => <OgdenModel notation={notation} language={language} onBack={() => goTo('D04')} /> },
]
