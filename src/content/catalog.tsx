...
export const modules: ModuleDefinition[] = [
  ...
  { id: 'K07', chapterId: 'kinematics', title: { ru: 'Меры деформации Грина–Лагранжа и Эйлера–Альманси', en: 'Green–Lagrange and Euler–Almansi strain measures' }, subtitle: { ru: 'E = 1/2(C − I), e = 1/2(I − B⁻¹)', en: 'E = 1/2(C − I), e = 1/2(I − B⁻¹)' }, render: ({notation,language,goTo}) => <StrainMeasures notation={notation} language={language} onBack={() => goTo('K06')} /> },
]
