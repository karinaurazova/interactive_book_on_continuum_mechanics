...
export const chapters: ChapterDefinition[] = [
  ...
  },
  {
    ...
    moduleIds: ['C00', 'C01', 'C02', 'C03', 'C04', 'C05', 'C06'],
  },
]
...
export const modules: ModuleDefinition[] = [
  ...
  { id: 'C06', chapterId: 'constitutive-modeling', title: { ru: 'Изотропная линейная упругость: E, ν, λ, μ, K и G', en: 'Isotropic linear elasticity: E, ν, λ, μ, K, and G' }, subtitle: { ru: 'два независимых параметра', en: 'two independent parameters' }, render: ({notation,language,goTo}) => <IsotropicElasticConstants notation={notation} language={language} onBack={() => goTo('C05')} /> },
]
